function FsGlobe() {
  ...
  // Disable vertical rotation when dragging
  // s.enableRotate = true;
  ...
  setTimeout(function () {
    ...
    //continuosly check if #load1 has opacity 0 or not, if 0 stop checking
    var load1Check = setInterval(function () {
      if ($("#load1").css("opacity") == 0) {
        clearInterval(load1Check);
        //click on #anim1
        $("#anim1").click();

        // console.log("Preload 1 completed");
      } else {
        // console.log("Preload 1 ongoing");
      }
    }, 1);

    //continuosly check if #load2 has opacity 0 or not, if 0 stop checking
    var load2Check = setInterval(function () {
      if ($("#load2").css("opacity") == 0) {
        clearInterval(load2Check);
        ...
        //     console.log("Preload 2 completed");
        ...
        // console.log("Preload 2 ongoing");
      }
    }, 1);
  }, 1000);
  u.needsUpdate = !0;

  const E = new THREE.SphereBufferGeometry(1, 1024, 512), // Increased segments
